...
// ----------------
	...
	/**
	 * Creates and stores a "\Lib\File" object of the source file
	 * @param string the source image filepath
	 * @return void
	 * @throw Throws an InvalidArgumentException if the file doesn't exist or is not an image
	 */
...
// ----------------
	 ...
	 * @throws Throws a RuntimeException if the extension is not standard
	 */
...
// ----------------
	 ...
	 * @param num $original_width The original width value, in pixels
	 * @param num $original_height The original height value, in pixels
	 * @param num $max_width The maximum width value, in pixels
	 * @param num $max_height The maximum height value, in pixels
